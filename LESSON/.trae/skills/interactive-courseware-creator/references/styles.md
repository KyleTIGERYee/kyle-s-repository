...
| 类名 | 字号 | 行高 | 用途 |
|------|------|------|------|
| `text-hero` | 72px | 1.1 | 封面主标题 |
| `text-hero-sub` | 36px | - | 封面副标题 |
| `text-title` | 48px | 1.2 | 页面大标题 |
| `text-subtitle` | 32px | 1.3 | 子标题、卡片标题 |
| `text-body` | 24px | 1.8 | 正文内容 |
| `text-label` | 20px | - | 标签、徽章、说明文字 |
| `code-block` | 20.8px | 1.8 | 代码块、提示词示例 |
