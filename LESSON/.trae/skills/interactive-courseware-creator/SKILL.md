...
| **对比说明** | 左右分栏 | 滑动对比器 | Before/After Slider | components-enhanced.md |
...
| `text-hero-sub` | 36px | 封面副标题 |
| `text-title` | 48px | 页面大标题 |
| `text-subtitle` | 32px | 子标题、卡片标题 |
| `text-body` | 24px | 正文内容 |
| `text-label` | 20px | 标签、徽章 |
| `code-block` | 20.8px | 代码块 |
